...
export interface CategoriaResolverPort {
  porId(id: string | null | undefined): Promise<{ id: string; slug: string; nombre: string } | null>;
}
...
export const categorizarRoute = (deps: CategorizarDeps): FastifyPluginAsync => async (app) => {
